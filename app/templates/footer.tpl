...
<!-- Footer -->
    <div id="footer">
      <p>
      Copyright &copy; 2013-2014 I Love Neutrinos, All Rights Reserved. 
      <a href="http://html5.validator.nu/?doc=http%3A%2F%2Fwww.iloveneutrinos.com%2F" target="_blank">This document is HTML5</a>
      </p>
    </div>
    ...
    <script type="text/javascript">
      ...
      ga('create','UA-343143-16');ga('send','pageview');
    </script>
    {/literal}